...
OFFLINE_PAUSE_BUTTON_NAMES = (
    ["PAUSE MENU"]
    + OPTION_BUTTONS_NAMES
    + ["OPEN TO LAN", "JOIN A GAME", "RETURN TO MENU"]
)

ONLINE_PAUSE_BUTTON_NAMES = (
    ["PAUSE MENU"] + OPTION_BUTTONS_NAMES + ["QUIT THE LAN", "RETURN TO MENU"]
)
...
OPEN_WORLD_FLAGS = {
    ...
    "HUDLoading": {
        ...
        "weight": OPEN_WORLD_FLAGS_WEIGHTS[
            "HUD_LOADING"
        ],  # Divided by 3 as there is 3 players
        "checked": False,
        "subflags": None,
    },
    "gameObjectLoading": {
